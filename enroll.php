...
<html lang="en" dir="ltr">
  ...
  <div class="container-md" style="max-width: 700px">
        ...
        if ((!isset($_POST['conf_check']) && !isset($_POST['gym_check']) && !isset($_POST['sauna_check'])) || empty($_POST['date']) || empty($_POST['time']) || $_POST['customer'] == "-1")
          ...
          if (isset($_POST['conf_check']) && $_POST['conf_check'] == "yes") {
            ...
            if (mysqli_fetch_row(mysqli_query($db, $check_if_enrolled))[0] == 1)
              echo '<div class="mb-3 alert alert-danger" role="alert">Customer has already enrolled in service Conference Room.</div>';
            else {
              ...
              if (mysqli_query($db, $insert_query))
                echo '<div class="mb-3 alert alert-success" role="alert">Customer enrolled in service Conference Room successfully.</div>';
            }
          }
          if (isset($_POST['gym_check']) && $_POST['gym_check'] == "yes") {
            $check_if_enrolled = "SELECT COUNT(*) from enroll_in e, customers c
                                  ...
                                  AND e.service_id = 6";
            if (mysqli_fetch_row(mysqli_query($db, $check_if_enrolled))[0] == 1)
              echo '<div class="mb-3 alert alert-danger" role="alert">Customer has already enrolled in service Gym.</div>';
            else {
              $insert_query = "INSERT INTO enroll_in
                               ...
                               WHERE c.verif_id = '$id'";
              if (mysqli_query($db, $insert_query))
                echo '<div class="mb-3 alert alert-success" role="alert">Customer enrolled in service Gym successfully.</div>';
            }
          }
          ...
          if (isset($_POST['sauna_check']) && $_POST['sauna_check'] == "yes") {
            $check_if_enrolled = "SELECT COUNT(*) from enroll_in e, customers c
                                  ...
                                  AND e.service_id = 7";
            if (mysqli_fetch_row(mysqli_query($db, $check_if_enrolled))[0] == 1)
              echo '<div class="mb-3 alert alert-danger" role="alert">Customer has already enrolled in service Sauna.</div>';
            else {
              $insert_query = "INSERT INTO enroll_in
                               ...
                               WHERE c.verif_id = '$id'";
              if (mysqli_query($db, $insert_query))
                echo '<div class="mb-3 alert alert-success" role="alert">Customer enrolled in service Sauna successfully.</div>';
            }
          }
        }
      }
    ...
    <form class="mb-3 mx-auto" action="enroll.php" method="POST">
      <div class="mb-3">
