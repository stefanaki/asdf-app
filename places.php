...
<html lang="en" dir="ltr">
  ...
  <div class="container-fluid">
    <h3 class="mb-4 mt-3" style="text-align: center">Places</h3>
        <h5 class="mb-3 mt-3" style="text-align: center">Most visited places per age group for the past month</h5>
      ...
      <h5 class="mb-3 mt-3" style="text-align: center">Most visited places per age group for the past year</h5>
