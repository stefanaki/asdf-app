...
<html lang="en" dir="ltr">
  ...
  <div class="container-fluid">
    ...
    <h5 class="mb-3 mt-3" style="text-align: center">Most used services per age group for the past month</h5>
  ...
  <h5 class="mb-3 mt-3" style="text-align: center">Most used services per age group for the past Year</h5>
...
<h5 class="mb-3 mt-3" style="text-align: center">Most used services by most customers per age group for the past month</h5>
<div class="accordion mx-auto" id="ac3" style="width: 40%">
<div class="accordion-item">
...
<h5 class="mb-3 mt-3" style="text-align: center">Most used services by most customers per age group for the past year</h5>
<div class="accordion mx-auto" id="ac4" style="width: 40%">
<div class="accordion-item">
